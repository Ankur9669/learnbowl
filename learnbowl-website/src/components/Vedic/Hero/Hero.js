...
function Hero() {
  ...
  function handleFormSubmit(e) {
    ...
    if (isNameValid && isContactNumberValild && isEmailValid && isCityValid) {
      isFormValid = true;
    }
  ...
  return (
    <div className="hero-vedic">
      <img src="/french-wave-1.svg" alt="wave" className="vedic-wave1" />
      <img src="/french-wave-2.svg" alt="wave" className="vedic-wave2" />
      <img src="/french-wave-3.svg" alt="wave" className="vedic-wave3" />
      <img src="/french-wave-4.svg" alt="wave" className="vedic-wave4" />
      <div className="hero-vedic-section-1">
        <div className="hero-vedic-section-1-text">
          <p className="hero-vedic-section-1-info-1">
          ...
          <h1 className="hero-vedic-section-1-heading">
            Learn&nbsp;
          ...
          {width > 768 && (
            <p className="hero-vedic-section-1-info-2">
              Learn Vedic Maths Online: Register for workshop
            </p>
          )}
          {width < 768 && (
            <p className="hero-vedic-section-1-info-2">
        ...
        <div className="hero-vedic-section-1-img-container">
          <img src="/Maths1.png" className="hero-vedic-section-1-img"></img>
          {/* <object
            data="/vedicHeroImg.svg"
            type="image/svg+xml"
            alt="image"
            className="hero-vedic-section-1-img"
          ></object> */}
        </div>
      </div>
      <div className="hero-vedic-section-2">
        {width > 800 ? (
          <img
            src="/vedicMathsFormImg.svg"
            alt="image"
            className="vedic-hero-section-2-bastille"
          ></img>
        ) : (
          <img
            src="/vedicMathsFormImg.svg"
        ...
        <h3 className="hero-vedic-section-2-heading">
