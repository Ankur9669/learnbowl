        ...
        <div className = "hero-frenchschool">
            ...
            <div className = "hero-frenchschool-section-1">
                <div className = "hero-frenchschool-section-1-text">
                    <p className = "hero-frenchschool-section-1-info-1">Learn from India’s best teachers!</p>
                    ...
                    <h1 className = "hero-frenchschool-section-1-heading">Learn&nbsp;
                    ...
                    {width > 768 && <p className = "hero-frenchschool-section-1-info-2">Learn French Online: Register for workshop</p>}
                    {width < 768 && <p className = "hero-frenchschool-section-1-info-2">Learn Online: Register for workshop</p>}
                </div>
                <div className = "hero-frenchschool-section-1-img-container">
                    {/* <img src= "frenchB2B-hero-img.svg" className = "hero-frenchschool-section-1-img"></img> */}
