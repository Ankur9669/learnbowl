...
function Section5() 
{
    ...
    return (
        <div className = "frenchschool-section-5">
            <h3 className = "frenchschool-section-5-heading">Our <span style = {{color: "#2D3092"}}>Accomplishments</span></h3>
            <div className = "frenchschool-section-5-caraousel-container">
                <Carousel
                    value={value}
                    onChange={onChange}
                    plugins={[
                    ...
                    <div className = "frenchschool-section-5-card">
                        <img src = "/home-half-pink-ellipse.svg" alt = "" className = "frenchschool-section-5-card-pink-ellipse"></img>
                        <img src = "/home-half-pink-ellipse-mobile.svg" alt = "" className = "frenchschool-section-5-card-pink-ellipse-mobile"></img>
                        <p className = "frenchschool-section-5-card-text">
                         ...
                         <div className = "frenchschool-section-5-card-reviewer-container">
