...
const LazyRegistrationSuccesfull = lazy(() =>
  import("./components/RegistrationSuccesfull/RegistrationSuccesfull")
);
const LazyFrenchSchool = lazy(() =>
  import("./components/FrenchSchool/FrenchSchool")
);
const LazyFrenchSchoolConfirmReg = lazy(() =>
  import("./components/FrenchschoolConfirmReg/FrenchschoolConfirmReg")
);
